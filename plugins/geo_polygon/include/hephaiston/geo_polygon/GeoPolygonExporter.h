...
class IGeoPolygonExporter { public: virtual ~IGeoPolygonExporter()=default; virtual std::string_view id() const=0; virtual std::string_view displayName() const=0; virtual ExportResult exportPolygons(const ExportRequest& request)=0; };
} // namespace hephaiston::geo_polygon
